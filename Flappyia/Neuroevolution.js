...
var Neuroevolution = function (options) {
	...
	self.options = {
		...
		network: [0, [0], 0], // Perceptron network structure (1 hidden
		// layer).
		population: 50, // Population by generation.
		elitism: 1, // Best networks kepts unchanged for the next
		// generation (rate).
		randomBehaviour: 0.01, // New random networks for the next generation
		// (rate).
		mutationRate: 0.1, // Mutation rate on the weights of synapses.
		mutationRange: 0.05, // Interval of the mutation changes on the
		// synapse weight.
		historic: 0.8, // Latest generations saved.
